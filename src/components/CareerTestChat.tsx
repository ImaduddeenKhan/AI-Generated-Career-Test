...
import { ArrowLeft, Send, Download, MessageSquare, List } from 'lucide-react';
...
export const CareerTestChat = ({ onBack }: CareerTestChatProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex flex-col">
      {/* Header */}
      <div className="bg-white/90 backdrop-blur-sm border-b border-gray-200 p-4 sticky top-0 z-10">
        <div className="container mx-auto flex items-center justify-between">
          <Button variant="ghost" onClick={onBack} className="flex items-center gap-2">
            <ArrowLeft className="w-4 h-4" />
            Back to Home
          </Button>
          <h1 className="text-xl font-semibold">India's 1st AI Career Test</h1>
